...
<svg width="${SVG_WIDTH}" height="${SVG_HEIGHT}" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Ray from near eye through white line to blue circle -->
  ${drawLightRay(eyeX + eyeWidth/2 + 15, eyeY - 33, 400 - sunRadius, 200)}
  
  <!-- Ray from blue circle up and toward the left -->
  ${drawLightRay(400 - sunRadius, 200, 50, 50)}
  
  <!-- Ray from eye through white line to right edge -->
  ${drawLightRay(eyeX + eyeWidth/2 + 20, eyeY - 14, 750, 220)}
</svg>`;
