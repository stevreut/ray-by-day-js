class Vector3D {
    ...
    reflect(normalVector) {
        ...
        // normalVector = vector normal to reflective surface
        // returned: resultant reflected vector
        const normalComponent = this.componentInDirectionOf(normalVector)
        return this.subt(normalComponent.scalarMult(2))
    }
}
